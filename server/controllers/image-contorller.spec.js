describe("Image service controller", function() {
    it("should have a endpoint that return Original image", () => {
        //`/image/{file.ext}`
    });

    it("should returns the image resized with aspect ratio maintained so that the largest edge is less than or equal to the value of `max` (number) in pixels", () => {
